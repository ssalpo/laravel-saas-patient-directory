                ...
                <form @submit.prevent="submit">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <date-time-picker :class="{'is-invalid': errors.birthday}" v-model="form.birthday" :value="form.birthday" :config="birthdayConfig" />
                        ...
                        <div class="form-group">
                            ...
                            <date-time-picker :class="{'is-invalid': errors.sampling_date}" v-model="form.sampling_date" :value="form.sampling_date" :config="sampleConfig" />
                        ...
                        <div class="form-group">
                            ...
                            <date-time-picker :class="{'is-invalid': errors.sample_receipt_date}" v-model="form.sample_receipt_date" :value="form.sample_receipt_date" :config="sampleConfig" />
                        ...
                        <div class="form-group">
                            <label>Анамнез</label>
                            <input type="text" :class="{'is-invalid': errors.anamnes}" class="form-control" v-model="form.anamnes">
                        ...
                        <div class="form-group">
                            ...
                            <select multiple class="form-control" :class="{'is-invalid': errors.categories}" v-model="form.categories">
                                <option v-for="category in categories" :value="category.id">{{`${category.name} - ${category.description}`}}</option>
                            </select>

                            <div v-if="errors.categories" class="error invalid-feedback">
                                {{ errors.categories }}
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" :class="{'is-invalid': errors.doctor_id}"  v-model="form.doctor_id">
...
export default {
    props: ['id', 'doctors', 'patient', 'categories', 'errors'],
